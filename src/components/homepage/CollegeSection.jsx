...
export default CollegeSection;
  ...
  //  const { data: searchedCollege = [], isPending: searchLoading, refetch: searchRefetch } = useQuery({
  //       queryKey: ['searchedCollege', search],
  //       queryFn: async () => {
  ...
  //   return { searchedCollege, searchLoading,searchRefetch  };